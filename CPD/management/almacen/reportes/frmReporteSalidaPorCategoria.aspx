<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/management/Site.Master" CodeBehind="frmReporteSalidaPorCategoria.aspx.vb" Inherits="CPD.frmReporteSalidaPorCategoria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="sinUpdatePanel" runat="server">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active text-uppercase">Salida por categoría</li>
        </ol>
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="card">
                    <div class="card-header ch-alt bgm-bluegray">
                        <h2>Reporte de salida por categoría</h2>
                    </div>
                    <div class="card-body">
...
<div class="row">
            <div class="col-md-12">
                <div class="card-body">
                    <div class="tab-content p-20">
                            <center> <rsweb:ReportViewer ID="rptSalidaPorCategoria" runat="server" Width="100%" SizeToReportContent="true"></rsweb:ReportViewer></center>
                        </div>
                    </div>
                </div>
        </div>
