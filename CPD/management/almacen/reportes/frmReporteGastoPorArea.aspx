<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/management/Site.Master" CodeBehind="frmReporteGastoPorArea.aspx.vb" Inherits="CPD.frmReporteGastoPorArea" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="sinUpdatePanel" runat="server">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="active text-uppercase">Gasto por área</li>
        </ol>
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="card">
                    <div class="card-header ch-alt bgm-bluegray">
                        <h2>Reporte de gasto por área</h2>
                    </div>
                    <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-body">
                            <div class="tab-content p-20">
                                <center>
                                <rsweb:ReportViewer ID="rptGastoPorArea" runat="server" Width="100%" SizeToReportContent="true"></rsweb:ReportViewer>
