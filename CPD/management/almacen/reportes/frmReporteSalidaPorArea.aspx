<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/management/Site.Master" CodeBehind="frmReporteSalidaPorArea.aspx.vb" Inherits="CPD.frmReporteSalidaPorArea" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="sinUpdatePanel" runat="server">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active text-uppercase">Salida por área</li>
        </ol>
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="card">
                    <div class="card-header ch-alt bgm-bluegray">
                        <h2>Reporte de salida por área</h2>
                    </div>
                    <div class="card-body">
                        ...
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                <div class="row">
                                    <center>
                                        <rsweb:ReportViewer ID="rptSalidaPorArea" runat="server" Width="100%" SizeToReportContent="true"></rsweb:ReportViewer>
                                    </center>
                                </div>
                            </ContentTemplate>
                        </asp:UpdatePanel>
