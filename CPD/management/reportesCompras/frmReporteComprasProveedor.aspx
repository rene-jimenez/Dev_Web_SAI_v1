<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/management/Site.Master" CodeBehind="frmReporteComprasProveedor.aspx.vb" Inherits="CPD.frmReporteComprasProveedor" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="sinUpdatePanel" runat="server">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="active text-uppercase">Compras a proveedores</li>
        </ol>
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="card">
                    <div class="card-header ch-alt bgm-bluegray">
                        <h2>Reporte compras a proveedores</h2>
                    </div>
                    <div class="card-body">
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            <div class="row">
                <center><rsweb:ReportViewer ID="rptReporteComprasProveedor" runat="server" Width="100%" SizeToReportContent="true"></rsweb:ReportViewer></center>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
