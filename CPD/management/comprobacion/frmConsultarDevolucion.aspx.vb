...
Public Class frmConsultarDevolucion : Inherits nspPaginaBase.PaginaBase
...
#Region "Metodos"
    Public Sub poblarCampos(id As Guid)
        ...
        lblFechas.Text = CDate(consultaComprobacion.fechaElaboracion.ToString).ToString("D", CultureInfo.CreateSpecificCulture("es-MX"))
...
#Region "Botones"
    ...
    Private Sub btnImprimir_Click(sender As Object, e As EventArgs) Handles btnImprimir.Click
        Dim idComprobacion = Request.QueryString("idComp")
        Response.Redirect("/management/comprobacion/reporteDevolucion/frmReporteDevolucion.aspx?idComp=" + idComprobacion.ToString)
    End Sub
#End Region
