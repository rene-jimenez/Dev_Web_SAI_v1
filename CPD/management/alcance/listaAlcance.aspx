<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/management/Site.Master" CodeBehind="listaAlcance.aspx.vb" Inherits="CPD.listaAlcance" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="sinUpdatePanel" runat="server">
       <div class="container">
        <ol class="breadcrumb">
            ...
            <li><a href="#" class="text-uppercase">ALCANCE DE GASTO</a></li><asp:HiddenField ID="hdfMoreVert" runat="server" />
        </ol>
        <div class="block-header">
            <h2 class="active text-uppercase">SOLICITUD DE ALCANCE DE GASTO</h2>
        </div>
        <div class="clearfix"></div>
        <div class="card">
            <div class="card-header ch-alt bgm-bluegray">
                <h2>Lista de solicitudes de alcance de gasto</h2>
            </div>
            <div class="card-body">
