<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/management/Site.Master" CodeBehind="frmReporteAlcance.aspx.vb" Inherits="CPD.frmReporteAlcance" %>
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header ch-alt bgm-bluegray">
                <h2>Reporte Alcance</h2>
            </div>
            <div class="card-body card-padding">
                <div class="row" >
                    <center><rsweb:ReportViewer ID="rptAlcance" runat="server" Width="100%" SizeToReportContent="true"></rsweb:ReportViewer></center>
                </div>
