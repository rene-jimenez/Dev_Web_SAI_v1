<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/management/Site.Master" CodeBehind="frmReporteGeneral.aspx.vb" Inherits="CPD.frmReporteGeneral" %>
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header ch-alt bgm-bluegray">
                <h2>Reporte solicitud de gastos</h2>
            </div>
            <div class="card-body card-padding">

                <div class="row" runat="server" id="divCmb">
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <CENTER><rsweb:ReportViewer ID="rptSolicitudGasto" runat="server" DocumentMapCollapsed="True" LinkDisabledColor="Black" PromptAreaCollapsed="True" Width="100%" SizeToReportContent="true" ></rsweb:ReportViewer></CENTER>
                </div>
