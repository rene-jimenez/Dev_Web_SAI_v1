<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/management/Site.Master" CodeBehind="frmReporteSolicitudGastoNoLiberado.aspx.vb" Inherits="CPD.frmReporteSolicitudGastoNoLiberado" %>
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="card">
                    <div class="card-header ch-alt bgm-bluegray">
                        <h2>Reporte de solicitud de gastos a comprobar "No liberados"</h2>
                    </div>
                    <div class="card-body">
                        <div class="tab-content p-20">
                            <div role="tabpanel" class="tab-pane animated fadeIn in active" id="tab-1">
                                <div class="form-horizontal">
                                        ...
                                        <ContentTemplate>
                                            <div class="form-group">
                                                <div class="col-sm-offset-4 col-sm-8 p-b-20">
                                                    <asp:LinkButton class="btn btn-primary" runat="server" ID="btnGenerarReporte" TabIndex="10" OnClick="btnGenerarReporte_Click"><i class="fa fa-print"></i> Generar reporte</asp:LinkButton>
                                 ...
                                 <div class="text-center" runat="server" id="resultadoVacioReporte" visible="false">
                                                    <div class="bgm-deeporange p-20">
                                                        ...
                                                        No existen resultados con esos criterios, revisa la información o llama a la Coordinación de Informática, al área de sistemas</h5>
                                                    </div>
                                                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-body">
                            <div class="tab-content p-20">
                                <center>
                           <rsweb:ReportViewer ID="rptSolGasComNoLib" runat="server" Width="100%" SizeToReportContent="true"></rsweb:ReportViewer>
                            </center>
                            </div>
                        </div>
                    </div>
