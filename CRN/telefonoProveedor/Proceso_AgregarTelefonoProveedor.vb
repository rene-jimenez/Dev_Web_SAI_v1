...
Namespace nspTelefonoProveedor
    Public Class Proceso_AgregarTelefonoProveedor : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As telefonoProveedor
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_AgregarTelefonoProveedor", "Agrega un registro a la base de datos")
        End Sub
