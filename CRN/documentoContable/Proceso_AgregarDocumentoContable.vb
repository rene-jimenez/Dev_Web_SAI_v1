...
Namespace nspDocumentoContable
    Public Class Proceso_AgregarDocumentoContable : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As documentoContable
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_AgregarDocumentoContable", "Agrega un registro a la base de datos")
        End Sub
