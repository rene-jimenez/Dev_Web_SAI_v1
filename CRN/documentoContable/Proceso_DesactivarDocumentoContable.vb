...
Namespace nspDocumentoContable
    Public Class Proceso_DesactivarDocumentoContable : Inherits Accion(Of respuestaDelProceso)

        Public Property entidad As documentoContable
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_DesactivardocumentoContable", "Desactiva un registro a la base de datos")
        End Sub
        ...
        Protected Overrides Function OnEjecutar() As respuestaDelProceso
            ...
            Try
                ...
                entidad._tipoEdicion = tipoEdicionDocumentoContable.cambiarEstado
