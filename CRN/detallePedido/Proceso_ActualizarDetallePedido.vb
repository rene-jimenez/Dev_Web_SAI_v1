...
Namespace nspDetallePedido
    Public Class Proceso_ActualizarDetallePedido : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As detallePedido
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_ActualizarDetallePedido", "Actualiza un registro a la base de datos")
        End Sub
