...
Namespace nspSistema
    Public Class Proceso_ActualizarSistema : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As sistema
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_ActualizarSistema", "Actualiza un registro a la base de datos")
        End Sub
        ...
        Protected Overrides Function OnEjecutar() As respuestaDelProceso
            ...
            Catch ex As SqlException
                If ex.Number = 2601 Then
                    respuesta.comentario = controladorMensajes.obtenerMensaje(tipoNotificacionesDeUsuario._El_registro_estaria_duplicado, "sistema")
