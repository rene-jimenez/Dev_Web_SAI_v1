...
Namespace nspCategoria
    Public Class Proceso_DesactivarCategoria : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As categoria
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_DesactivarCategoria", "Desactiva un registro a la base de datos")
        End Sub
        Protected Overrides Function OnEjecutar() As respuestaDelProceso
            ...
            Try
                ...
                entidad._tipoEdicion = tipoEdicionCategoria.cambiarEstado
