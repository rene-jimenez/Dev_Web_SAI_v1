...
Namespace nspCategoria
    Public Class Proceso_ActualizarCategoria : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As categoria
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_ActualizarCategoria", "Actualiza un registro a la base de datos")
        End Sub
        Protected Overrides Function OnEjecutar() As respuestaDelProceso
            ...
            Try
                ...
                entidad._tipoEdicion = tipoEdicionCategoria.editar
