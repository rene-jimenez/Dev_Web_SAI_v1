...
Namespace nspFirma
    Public Class Proceso_DesactivarFirma : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As firma
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_DesactivarFirma", "Desactiva un registro a la base de datos")
        End Sub
        Protected Overrides Function OnEjecutar() As respuestaDelProceso
            ...
            Try
                ...
                entidad._tipoEdicion = tipoEdicionFirma.cambiarEstado
