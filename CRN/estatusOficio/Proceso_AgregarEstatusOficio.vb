...
Namespace nspEstatusOficio
    Public Class Proceso_AgregarEstatusOficio : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As estatusOficio
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_AgregarEstatusOficio", "Agrega un registro a la base de datos")
        End Sub
