...
Namespace nspEstatusOficio
    Public Class Proceso_EliminarEstatusOficio : Inherits Accion(Of respuestaDelProceso)
        Public Property id As Guid
        Public Property idUsuarioMovimiento As Guid
        Public Property ipUsuario As String
        Public Property esActivo As Boolean
        Public Sub New()
            MyBase.New("Proceso_EliminarEstatusOficio", "Elimina un registro en la base de datos")
        End Sub
        ...
        Protected Overrides Function OnEjecutar() As respuestaDelProceso
            ...
            Dim entidad = New Proceso_ObtenerEstatusOficio() With {.id = id}.Ejecutar()
            Try
