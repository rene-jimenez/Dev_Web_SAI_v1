...
Namespace nspResponsable
    Public Class Proceso_ActualizarResponsable : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As responsable
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_ActualizarResponsable", "Actualiza un registro a la base de datos")
        End Sub
        ...
        Protected Overrides Function OnEjecutar() As respuestaDelProceso
            ...
            Try
                ...
                entidad._tipoEdicion = tipoEdicionResponsable.editar
