...
Namespace nspResponsable
    Public Class Proceso_AgregarResponsable : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As responsable
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_AgregarResponsable", "Agrega un registro a la base de datos")
        End Sub
