...
Namespace nspArticulo
    Public Class Proceso_DesactivarArticulo : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As articulo
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_DesactivarArticulo", "Desactiva un registro a la base de datos")
        End Sub
