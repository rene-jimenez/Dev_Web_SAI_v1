...
Namespace nspSalidaAlmacen
    Public Class Proceso_ActualizarSalidaAlmacen : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As salidaAlmacen
        Public Sub New()
            MyBase.New("Proceso_ActualizarSalidaAlmacen", "Actualiza un registro a la base de datos")
        End Sub
