...
Namespace nspAjusteArticuloInventario
    Public Class Proceso_AgregarAjusteArticuloInventario : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As ajusteArticuloInventario
        Public Sub New()
            MyBase.New("Proceso_AgregarAjusteArticuloInventario", "Agrega un registro a la base de datos")
        End Sub
        Protected Overrides Function OnEjecutar() As respuestaDelProceso
            ...
            Try
                Dim dao = New CAD.nspControladorDaos.ControladorDaosBase().ObtenerDao(Of CAD.nspAjusteArticuloInventario.daoAjusteArticuloInventario)()
                dao.Agregar(entidad)
