...
Namespace nspRubroRequerimiento
    Public Class Proceso_DesactivarRubroRequerimiento : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As rubroRequerimiento
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_DesactivarRubroRequerimiento", "Desactiva un registro a la base de datos")
        End Sub
        Protected Overrides Function OnEjecutar() As respuestaDelProceso
            ...
            Try
                ...
                entidad._tipoEdicion = tipoEdicionRubroRequerimiento.cambiarEstado
