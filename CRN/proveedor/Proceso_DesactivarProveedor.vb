...
Namespace nspProveedor
    Public Class Proceso_DesactivarProveedor : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As proveedor
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_DesactivarProveedor", "Desactiva un registro a la base de datos")
        End Sub
