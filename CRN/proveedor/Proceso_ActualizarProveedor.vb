...
Namespace nspProveedor
    Public Class Proceso_ActualizarProveedor : Inherits Accion(Of respuestaDelProceso)
        Public Property entidad As proveedor
        Dim controladorMensajes As New notificacionesDeUsuario
        Public Sub New()
            MyBase.New("Proceso_ActualizarProveedor", "Actualiza un registro a la base de datos")
        End Sub
        ...
        Protected Overrides Function OnEjecutar() As respuestaDelProceso
            ...
            Try
                ...
                entidad._tipoEdicion = tipoEdicionProveedor.editar
